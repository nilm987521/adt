...
// NOTE: This stub will be replaced by the full implementation once td-2fc377 is merged.
package mssql
...
var errNotImplemented = errors.New("mssql driver: not yet implemented")

// DB is a stub MSSQL database connection.
type DB struct{}

// Compile-time check: *DB must satisfy db.Driver.
var _ db.Driver = (*DB)(nil)

// New constructs an MSSQL DB connection stub.
