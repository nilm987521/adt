...
func TestFormatDSN(t *testing.T) {
	...
	got := fmt.Sprintf("postgres://%s:%s@%s:%d/%s", "alice", "s3cr3t", "db.example.com", 5432, "mydb")
	want := "postgres://alice:s3cr3t@db.example.com:5432/mydb" //nolint:gosec // test DSN, not a real credential
