...
// NOTE: This stub will be replaced by the full implementation once td-312dbb is merged.
package postgres
...
var errNotImplemented = errors.New("postgres driver: not yet implemented")

// DB is a stub PostgreSQL database connection.
type DB struct{}

// Compile-time check: *DB must satisfy db.Driver.
var _ db.Driver = (*DB)(nil)

// New constructs a PostgreSQL DB connection stub.
